...
Metodologia → docs/metodologia_fiar.md
Ciclo de Auditoria → docs/ciclo_auditoria.md
Dimensões de IAR → docs/dimensoes_avaliacao.md
Trilhas de Execução → docs/trilhas_execucao.md
Modelo de Maturidade → docs/modelo_maturidade.md
Governança → docs/governanca_auditoria.md
